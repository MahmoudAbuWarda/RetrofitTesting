...
class WomanFragment : Fragment() {
    ...
    var listener: WomensFragmentListener?=null
    override fun onAttach(context: Context) {
        super.onAttach(context)
        if(context is MyListFragment.ListFragmentListener){
            listener=context as WomensFragmentListener
        }
...
//        }
        ...
        rv.layoutManager= GridLayoutManager(view.context,2, RecyclerView.VERTICAL ,false)
         ...
         catageyViewModel.getCatagory("women's clothing").observe(viewLifecycleOwner,{
    ...
    public interface WomensFragmentListener{
